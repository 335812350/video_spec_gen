...
| 类型 | 生成方式 | 输出 |
|---|---|---|
| TTS 旁白 | 用阿里云 TTS，选择与模型匹配的男声 / 略沉稳 / 偏纪录片旁白感 / 1.0x 速率（先查询当前 Workspace 的 model + voice ID） | audio/narration.wav |
...
- Voice ID：语气基调描述为"男声 / 略沉稳 / 纪录片旁白感"，先查询与所选阿里云模型匹配的 voice ID，建议试听 2-3 个再定稿
